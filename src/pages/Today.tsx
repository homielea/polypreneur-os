...
import { useReflectionMaterial } from "@/hooks/useReflectionMaterial";
...
export default function Today() {
  ...
  const ranked = useMemo(
    () =>
      actions
        ? scoringEngine.rank(actions, { now: new Date(), categoryActivity, reflectionMaterial })
        : [],
    [actions, categoryActivity, reflectionMaterial],
  );
