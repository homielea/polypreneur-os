...
export interface ScoringContext {
  now: Date;
  /**
   * Most recent score-event timestamp (ISO) per category, all-time. Absent
   * key = that category has never recorded points; undefined map = data not
   * loaded yet, and activity-based providers stay silent.
   */
